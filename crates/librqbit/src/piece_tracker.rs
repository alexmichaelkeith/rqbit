...
use crate::{
    ...
    file_info::FileInfo,
    type_aliases::{FileInfos, PeerHandle},
};
    ...
    S: Fn(ValidPieceIndex) -> bool,
{
    ...
    /// File download ordering. An empty slice disables non-priority fallback.
    pub file_priorities: &'a [usize],
...
impl PieceTracker {
    ...
    /// Iterate over pieces that are currently assigned to peers.
    pub fn iter_inflight_pieces(&self) -> impl Iterator<Item = ValidPieceIndex> + '_ {
...
mod tests {
    ...
    use crate::{
        ...
        type_aliases::{BF, FilePriorities},
    };
